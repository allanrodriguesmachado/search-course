$(function () {
    ...
    function handleCollapse(event) {
        ...
        collapse = $(this).closest('.app_collapse');
    ...
    $(".mobile_menu").on("click", handleMobileMenu);
    $(".search_open").on("click", handleSearchOpen)
    $(".collapse").on("click", handleCollapse)
