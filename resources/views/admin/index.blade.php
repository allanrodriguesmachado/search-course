...
<head>
    ...
    <link rel="stylesheet" href="{{asset('build/assets/login-db0683df.css')}}"/>
...
<script src="{{asset('build/assets/jquery.min-355160b9.js')}}"></script>
<script src="{{asset('build/assets/login-af4d5631.js')}}"></script>
